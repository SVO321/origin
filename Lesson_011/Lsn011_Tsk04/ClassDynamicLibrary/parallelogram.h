...
{
public:
    __declspec(dllexport) Parallelogram(int in_side_length_a, int in_side_length_b, int in_side_length_c, int in_side_length_d,
        int in_angle_value_A, int in_angle_value_B, int in_angle_value_C, int in_angle_value_D);
    __declspec(dllexport) Parallelogram();
